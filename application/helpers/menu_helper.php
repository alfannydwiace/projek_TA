...
function menu(){
	...
	<ul>
		...
		foreach($menu as $m){ 
			...
			<li class="<?php if($submenu->num_rows() > 0){ echo 'drop-down'; } ?>">
				<a <?php if($m->menu_opentab == "y"){echo "target='_blank'";} ?> class="nav-link js-scroll" href="<?php echo $m->menu_url; ?>"><?php echo $m->menu_nama; ?> 
...
function menu_anak($id){
	...
	<ul>
		...
		foreach($menu as $m){ 
			...
			<li class="<?php if($submenu->num_rows() > 0){ echo 'drop-down'; } ?>">
				<a <?php if($m->menu_opentab == "y"){echo "target='_blank'";} ?> href="<?php echo $m->menu_url; ?>"><?php echo $m->menu_nama; ?> </a>
