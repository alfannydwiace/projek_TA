<div class="content-wrapper">
	...
	<section class="content">
		...
		<form method="post" action="<?php echo base_url('dashboard/agenda_aksi') ?>" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-9">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<label>Nama</label>
											<input type="text" name="nama" class="form-control" placeholder="Masukkan nama agenda.." value="<?php echo set_value('nama'); ?>">
											<br/>
									...
									<div class="col-lg-4">
										<div class="form-group">
											<label>Tempat</label>
											<input type="text" name="tempat" class="form-control" placeholder="Masukkan tempat.." value="<?php echo set_value('tempat'); ?>">
											<br/>
