<div class="content-wrapper">
	...
	<section class="content">
		...
		<a href="<?php echo base_url().'peternak/produk'; ?>" class="btn btn-sm btn-primary">Kembali</a>
		...
		<form method="post" action="<?php echo base_url('peternak/produk_update') ?>" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-9">
