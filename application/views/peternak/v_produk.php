	...
	<section class="content">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<a href="<?php echo base_url().'peternak/produk_tambah'; ?>" class="btn btn-sm btn-primary">Tambah Produk Baru</a>
							...
							<tbody>
								...
								foreach($produk as $a){ 
									...
									<tr>
										...
										<td>
											<a href="<?php echo base_url().'peternak/produk_edit/'.$a->produk_id; ?>" class="btn btn-warning btn-sm"> <i class="fa fa-pencil"></i> </a>
											<a onclick="return confirm('Yakin ingin hapus?')" href="<?php echo base_url().'peternak/produk_hapus/'.$a->produk_id; ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a>
										</td>
									</tr>
								<?php } ?>
							</tbody>
