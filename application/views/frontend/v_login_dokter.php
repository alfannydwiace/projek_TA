          ...
          <div class="slider-content text-center" style="padding-top: 12%;padding-bottom: 3%">
            <div class="header-bottom">
              <div class="layer2 wow zoomIn" data-wow-duration="1s" data-wow-delay=".4s">
                <h1 class="title2">Login Dokter</h1>
              </div>
              <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                <ol class="breadcrumb d-flex justify-content-center" style="background: transparent;">
                  ...
                  <li class="breadcrumb-item">
                    <a class="text-white" href="<?php echo base_url('blog'); ?>">Login Dokter Hewan</a>
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
       ...
       <div class="col-md-5 col-sm-12 col-xs-12">
        ...
        <form method="post" action="<?php echo base_url('welcome/login_dokter_act') ?>">
